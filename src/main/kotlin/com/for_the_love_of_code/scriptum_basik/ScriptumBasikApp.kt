...
class ScriptumBasikApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes scriptum_basik.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<ScriptumBasikApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(ScriptumBasikApp::class.java)
