package com.for_the_love_of_code.scriptum_basik.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.for_the_love_of_code.scriptum_basik.repository..*)" +
            " || within(com.for_the_love_of_code.scriptum_basik.service..*)" +
            " || within(com.for_the_love_of_code.scriptum_basik.web.rest..*)"
    )
