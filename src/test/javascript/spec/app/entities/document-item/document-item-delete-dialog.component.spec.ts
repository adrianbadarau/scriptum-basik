...
import { DocumentItemDeleteDialogComponent } from 'app/entities/document-item/document-item-delete-dialog.component';
  ...
  describe('DocumentItem Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [DocumentItemDeleteDialogComponent]
      })
