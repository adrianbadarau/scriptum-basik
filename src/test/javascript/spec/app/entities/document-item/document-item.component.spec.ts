...
import { DocumentItemComponent } from 'app/entities/document-item/document-item.component';
...
describe('Component Tests', () => {
  describe('DocumentItem Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.documentItems && comp.documentItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
