...
describe('Service Tests', () => {
  describe('DocumentItem Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(DocumentItemService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new DocumentItem(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a DocumentItem', () => {
        ...
        service.create(new DocumentItem()).subscribe(resp => (expectedResult = resp.body));
